...
<html>
	...
	<body>
		...
		<div id="edit-comments" class="content scaffold-edit" role="main">
			...
			<g:hasErrors bean="${comments}">
			<ul class="errors" role="alert">
				<g:eachError bean="${comments}" var="error">
				<li <g:if test="${error in org.springframework.validation.FieldError}">data-field-id="${error.field}"</g:if>><g:message error="${error}"/></li>
				</g:eachError>
			</ul>
			</g:hasErrors>
			<g:form url="[resource:comments, action:'update']" method="PUT" >
				<g:hiddenField name="version" value="${comments?.version}" />
				<fieldset class="form">
