...
<html>
	...
	<body>
		...
		<div id="edit-operationHistory" class="content scaffold-edit" role="main">
			...
			<g:hasErrors bean="${operationHistoryInstance}">
			<ul class="errors" role="alert">
				<g:eachError bean="${operationHistoryInstance}" var="error">
				<li <g:if test="${error in org.springframework.validation.FieldError}">data-field-id="${error.field}"</g:if>><g:message error="${error}"/></li>
				</g:eachError>
			</ul>
			</g:hasErrors>
			<g:form url="[resource:operationHistoryInstance, action:'update']" method="PUT" >
				<g:hiddenField name="version" value="${operationHistoryInstance?.version}" />
				<fieldset class="form">
